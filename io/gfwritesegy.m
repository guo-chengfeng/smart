function  gfwritesegy(data,varargin)
% GFWRITESEGY creates a SEGY file and writes data;discard existing
%   contents
%
%   call:
%
%   gfwritesegy(data) writes data to a default file whose name after data
%       default: dt=0.001s
%
%   gfwritesegy(data,fileName) writes data to the IEEE segy file, dt
%       default: dt=0.001s
%
%   gfwritesegy(data,fileName,dt) writes data to the IEEE segy file
%
%   gfwritesegy(data,fileName,dt,'ibm') writes data to the IBM segy file
%
%   Version: V1.0
%   Author : C.F.Guo
%   Time   : 2015/9/11
