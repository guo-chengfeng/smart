function  gfwritesegyhdr2(data,varargin)
% GFWRITESEGYHDR2  writes data to a existing SEGY file, and if the given 
%   file don't exist, creates it and writes data
%
%   call:
%
%   gfwritesegyhdr2(data,header) writes data to a default file whose 
%   name after data
%
%   gfwritesegyhdr2(data,header,fileName) writes data to the IEEE segy file
%
%   gfwritesegyhdr2(data,header,fileName,'ibm') writes data to the IBM segy file
%
