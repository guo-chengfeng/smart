function  outp= gfsbLx1_3D_opt( inp,dx)
% GFSBLX1_3D_OPT is 3D 12th-order backward staggered-grid finite-difference 
%   operator for 1st-order x-axis derivative.
%
%   call:
%
%   dat1 = gfsbLx1_3D_opt(dat,dx).
