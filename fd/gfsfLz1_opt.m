function  outp= gfsfLz1_opt( inp,dz)
% GFSFLZ1_OPT is 2D 12th-order forward staggered-grid finite-difference 
%   operator for 1st-order z-axis derivative.
%
%   call:
%
%   dat1 = gfsfLz1_opt(dat,dz).
...
%   on least-squares for wave equation modelling, 2014, LiuYang
%
%   Version: V1.0
%   Author : C.F.Guo
%   Time   : 2015/9/11 
