function  outp= gfsbLz1_3D_opt( inp,dz)
% GFSBLZ1_3D_OPT is 3D 12th-order backward staggered-grid finite-difference 
%   operator for 1st-order z-axis derivative.
%
%   call:
%
%   dat1 = gfsbLz1_3D_opt(dat,dz).
