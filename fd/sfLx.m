function  outp= sfLx(inp,dx)
% SFLX is abbreviation of GFSFLX1_OPT for convenience.
% GFSFLX1_OPT is 2D 12th-order forward staggered-grid finite-difference 
%   operator for 1st-order x-axis derivative.
%
%   call:
%
%   dat1 = gf_sfLx1_opt(dat,dx).
