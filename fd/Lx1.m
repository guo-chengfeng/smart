function  outp= Lx1(inp,dx)
% LX is a 2D 12-order central-grid finite-difference operator for 
%   1st-order x-axis derivative uisng the optimized FD coefficients
