function r = gfLy2_3D_opt(s,dy)
%GFLY2_3D_OPT is 3D 8th-order central-grid finite-difference operator for 
%   2nd-order y-axis derivative.
%
%   call:
%
%   dat1 = gfLy2_3D_opt(dat,dy).
