function pdat = gfgprmedfilt(cdat,dirflag)
%GFGPRMEDFILT apply median filter to data along X and Z axis.
%   gfgprmedfilt apply medfilt1 to the data along X axis using the past data 
%              point and to data along Z axis using the past and future data.
%   Usage:
%   pdat=gfgprmedfilt(cdat)          % dirflag='z';
%   pdat=gfgprsmooth(cdat,dirflag)  
%
%   Author: C.F. Guo
%   Date:   26-Oct-2016
