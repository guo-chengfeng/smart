function result = gfcrossprod(sym1,sym2)
%GFCROSSPROD return a cross product of two tensors [1- or 2-order]
%   GFCROSSPROD(sym1,sym2) returns a dot product of two tensor sym1,sym2
